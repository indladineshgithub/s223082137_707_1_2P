...
public class SeleniumOperations {
	...
	public static void open_chrome_and_close() {
		...
		System.setProperty("webdriver.chrome.driver", "C://Dinesh//24-T1//707//Task1//chromedriver-win64//chromedriver-win64//chromedriver.exe");
	...
	public static void open_chrome_loadpage_resize_close() {
		...
		System.out.println("Hello from <223082137>, <Dinesh Reddy Indla>");
